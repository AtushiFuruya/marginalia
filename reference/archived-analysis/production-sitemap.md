...
- **役割**: サイトのエントリーポイント。18歳以上確認→フルスクリーンスライド→メインビュー表示までを単一HTMLで完結。
- **機能**:
  - 年齢確認ダイアログ（Enter/Exit、キーボード操作）
  - バックグラウンドムービー＋静止画スライド（リサイズ追従）
  - オープニングスライドショー（5枚・スキップボタン・プログレスバー）
  - メインビュー（Coming Soon。将来的にギャラリー／最新情報を配置）
- **必要リソース**:
