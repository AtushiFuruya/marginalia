...
- `responsive-design-2025.md` - レスポンシブデザインガイド（2025年版）
...
### 参考サイトを確認する場合
1. `analyzed-sites/bug-system/ANALYSIS-SUMMARY.md` で概要を確認
2. `analyzed-sites/bug-system/sitemap-summary.md` でサイト構造を確認
3. `screenshots/` で実際の見た目を確認
...
### 2025-11-07
- ✅ 重複ファイルを削除（5ファイル、約100KB削減）
- ✅ ファイル名をわかりやすく変更
- ✅ `responsive-design-2025.md` を追加
- ✅ `ANALYSIS-SUMMARY.md` を作成
